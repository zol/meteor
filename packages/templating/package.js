...
Package.on_use(function (api) {
  ...
  // XXX Hack: by using handlebars we force Package.handlebars to
  // exist, so that the code generated by html_scanner (which could be
  // injected into any namespace in the app) can get at it.
